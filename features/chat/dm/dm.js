...
import { nameToEmail, emailToName } from '../../../js/services/follow.js';
import { getDMMessages, sendDMMessage } from '../../../js/services/dm.js';
...
function renderDesktop(session, otherEmail, otherName) {
  ...
  el.innerHTML = `
    ...
    <div style="display:flex;align-items:center;gap:0.5rem;padding:0.75rem 0;border-top:1px solid var(--border-color);margin-top:0.5rem">
      <input class="dm-input" type="text" placeholder="Tulis pesan..." maxlength="${LIMITS.MAX_DM_MESSAGE_LENGTH}" autocomplete="off" style="flex:1;border:1px solid var(--border-color);background:var(--bg-elevated);color:var(--text);font-size:0.9rem;padding:0.65rem 1rem;border-radius:999px;outline:none;font-family:inherit" />
